        ...
        <div class="col-md-8 col-lg-7">
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div class="card-body p-5">
                    ...
                    <?php if(session('error')): ?>
                        <div class="alert alert-danger alert-dismissible fade show rounded-3" role="alert">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-2"><?php echo e(session('error')); ?></div>
                            </div>
                    ...
                    <div id="step1">
                        <form method="POST" action="<?php echo e(route('password.verify-email')); ?>" id="emailForm">
                            <?php echo csrf_field(); ?>
                            <div class="mb-4">
                    ...
                    <div id="step2" style="display: none;">
                        <form method="POST" action="<?php echo e(route('password.verify-answers')); ?>" id="securityForm">
                            <?php echo csrf_field(); ?>
                    ...
                    <div id="step3" style="display: none;">
                        <form method="POST" action="<?php echo e(route('password.reset-by-questions')); ?>" id="passwordForm">
                            <?php echo csrf_field(); ?>
                    ...
                    <div class="text-center">
                        <a href="<?php echo e(route('login')); ?>" class="text-decoration-none">← Volver al inicio de sesión</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    document.getElementById('emailForm').addEventListener('submit', function(e) {
        ...
        fetch('<?php echo e(route("password.verify-email")); ?>', {
            method: 'POST',
            headers: {
    ...
    document.getElementById('securityForm').addEventListener('submit', function(e) {
        ...
        fetch('<?php echo e(route("password.verify-answers")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/jordanys/Escritorio/proyecto x/back-laravel/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>