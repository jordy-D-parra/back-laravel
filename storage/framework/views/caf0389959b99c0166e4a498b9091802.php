<?php $__env->startSection('title', 'Sesiones Activas'); ?>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <span class="badge bg-success" style="font-size: 1.2rem;">
                            <?php echo e($sessions->count()); ?> conectados
                        </span>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                              <tr>
                                <td>
                                    <strong><?php echo e($session->name); ?></strong><br>
                                    <small class="text-muted"><?php echo e($session->email); ?></small>
                                </td>
                                <td><?php echo \App\Models\User::find($session->user_id)?->role_badge; ?></td>
                                <td><?php echo e(\Carbon\Carbon::createFromTimestamp($session->last_activity)->format('d/m/Y H:i:s')); ?></td>
                                <td><code><?php echo e($session->ip_address ?? 'N/A'); ?></code></td>
                                <td>
                                    <button onclick="confirmClearSession(<?php echo e($session->user_id); ?>)"
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/jordanys/Escritorio/proyecto x/back-laravel/resources/views/audit/sessions.blade.php ENDPATH**/ ?>