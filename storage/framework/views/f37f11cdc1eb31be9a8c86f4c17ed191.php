...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - Sistema</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <?php if(Auth::check() && Auth::user()->hasAccess('worker')): ?>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('admin.users')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.*') ? 'active' : ''); ?>">
                    <i>👑</i>
            ...
            <?php if(Auth::check() && Auth::user()->isSuperAdmin()): ?>
            <li class="nav-item">
                <a href="<?php echo e(route('audit.logs')); ?>" class="nav-link <?php echo e(request()->routeIs('audit.logs') ? 'active' : ''); ?>">
                    <i>📋</i>
            ...
            <?php if(Auth::check() && Auth::user()->isSuperAdmin()): ?>
            <li class="nav-item">
                <a href="<?php echo e(route('audit.sessions')); ?>" class="nav-link <?php echo e(request()->routeIs('audit.sessions') ? 'active' : ''); ?>">
                    <i>🟢</i>
        ...
        <div class="topbar">
            ...
            <div class="user-menu">
                <div class="user-info">
                    ...
                    <p class="user-role"><?php echo Auth::user()->role_badge; ?></p>
                </div>
...
<?php /**PATH /home/jordanys/Escritorio/proyecto x/back-laravel/resources/views/layouts/dashboard.blade.php ENDPATH**/ ?>