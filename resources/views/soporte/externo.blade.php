        ...
        <div style="padding: 30px;">
            <form action="{{ route('soporte.externo.store') }}" method="POST">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <input type="text" name="nombre_equipo" required style="width: 100%; padding: 12px; border: 2px solid #e9ecef; border-radius: 12px;" placeholder="Ej: Laptop Dell, Impresora HP...">
                </div>

                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    <div>
                        <label style="display: block; font-weight: 600; margin-bottom: 8px;">Serial</label>
                        <input type="text" name="serial" style="width: 100%; padding: 12px; border: 2px solid #e9ecef; border-radius: 12px;" placeholder="Número de serie">
                    </div>
                    <div>
                        <label style="display: block; font-weight: 600; margin-bottom: 8px;">Marca</label>
                        <input type="text" name="marca" style="width: 100%; padding: 12px; border: 2px solid #e9ecef; border-radius: 12px;" placeholder="Marca del equipo">
                    </div>
                    <div>
                        <label style="display: block; font-weight: 600; margin-bottom: 8px;">Modelo</label>
                        <input type="text" name="modelo" style="width: 100%; padding: 12px; border: 2px solid #e9ecef; border-radius: 12px;" placeholder="Modelo">
                    </div>
                </div>
