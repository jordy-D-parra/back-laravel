...
<li class="nav-item">
    <a class="nav-link" href="{{ route('solicitudes.index') }}">
        <i class="fas fa-clipboard-list"></i> Mis Solicitudes
            ...
            <!-- ========== INVENTARIO - Solo para super_admin y admin ========== -->
        ...
        <!-- APROBACIONES - Solo para super_admin y admin -->
@if(Auth::check() && (Auth::user()->isSuperAdmin() || Auth::user()->isAdmin()))
<li class="nav-item">
    <a href="{{ route('aprobaciones.index') }}" class="nav-link {{ request()->routeIs('aprobaciones.*') ? 'active' : '' }}">
        ...
        @if($pendientesCount > 0)
            <span style="background: #e63946; color: white; border-radius: 20px; padding: 2px 8px; font-size: 11px; margin-left: auto;">{{ $pendientesCount }}</span>
        @endif
    </a>
</li>
@endif
...
<li class="nav-item">
    <a href="{{ route('soporte.index') }}" class="nav-link {{ request()->routeIs('soporte.*') ? 'active' : '' }}">
        ...
        @if($soportePendientes > 0)
            <span style="background: #e63946; color: white; border-radius: 20px; padding: 2px 8px; font-size: 11px; margin-left: auto;">{{ $soportePendientes }}</span>
        @endif
    </a>
</li>
