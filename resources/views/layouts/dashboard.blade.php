...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <!-- ============================================ -->
            <!-- SECCIÓN 2: ADMINISTRACIÓN (solo admin y super_admin) -->
            <!-- ============================================ -->
            ...
            <!-- Técnicos -->
            <li class="nav-item">
                <a href="{{ route('admin.tecnicos.index') }}" class="nav-link {{ request()->routeIs('admin.tecnicos.index') ? 'active' : '' }}">
                    <span class="nav-icon">
                        <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" fill="none">
 ...
 <li class="nav-item">
    ...
    <a href="{{ route('admin.categorias.index') }}" class="nav-link">
        ...
        <span>Categorías</span>
                    ...
                    <li class="nav-item">
                        <a href="javascript:void(0)" class="nav-link pending">
                            <span class="nav-icon">
                                <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" fill="none">
            ...
            <li class="nav-item has-submenu">
                ...
                <ul class="submenu">
                    <li class="nav-item">
            <a href="{{ route('admin.instituciones.index') }}" class="nav-link">
                <span class="nav-icon">
                    <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" fill="none">
                        <rect x="4" y="8" width="16" height="12" rx="1"/>
                        <path d="M8 20V8M16 20V8M4 12h16"/>
        ...
        <li class="nav-item">
            <a href="{{ route('admin.responsables.index') }}" class="nav-link">
                <span class="nav-icon">
                    <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" fill="none">
                        <path d="M20 7h-4.18A3 3 0 0 0 14 5.18V4a2 2 0 0 0-2-2"/>
                        <path d="M4 7h16v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V7z"/>
            ...
            <!-- Componentes -->
            <li class="nav-item">
    <a href="{{ route('admin.componentes.index') }}" class="nav-link">
        <span class="nav-icon">
            <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" fill="none">
                <rect x="2" y="4" width="20" height="16" rx="2"/>
        ...
        <span>Componentes</span>
            ...
            <!-- ============================================ -->
            <!-- SECCIÓN 5: AUDITORÍA (solo super_admin) -->
            <!-- ============================================ -->
            @if(Auth::check() && Auth::user()->isSuperAdmin())
            <li class="nav-section">AUDITORÍA</li>
    ...
    <script>
        ...
        document.querySelectorAll('.submenu-toggle').forEach(toggle => {
            toggle.addEventListener('click', function(e) {
                ...
                // Toggle expanded class en el toggle
                this.classList.toggle('expanded');

                // Encontrar el submenu
