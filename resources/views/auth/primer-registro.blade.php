        ...
        <div class="primer-registro-form">
            <div class="text-center mb-4">
                <div class="d-inline-block mb-3">
                    <div class="bg-warning bg-opacity-10 rounded-circle p-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#1e3c72" class="bi bi-shield-lock" viewBox="0 0 16 16">
                ...
                <p class="text-muted">Registre al <strong>Administrador del Sistema</strong></p>
                <div class="alert alert-info mt-2 py-2" style="font-size: 0.8rem; background: #e3f2fd; border-radius: 8px;">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0d6efd" stroke-width="2" class="me-1" style="display: inline-block; vertical-align: middle;">
                        <circle cx="12" cy="12" r="10"/>
                        <path d="M12 16v-4M12 8h.01"/>
                    </svg>
                    <span>El primer usuario será <strong>Administrador</strong> con todos los permisos del sistema</span>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('primer.registro') }}">
                ...
                <button type="submit" class="btn btn-success btn-lg w-100">
                    ...
                    Inicializar Sistema como Administrador
                </button>
            </form>
        </div>
    </div>
