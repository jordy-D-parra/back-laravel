...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="fw-bold" style="color: #1e3c72;">Gestión de Usuarios</h3>
    ...
    <form method="GET" action="{{ route('admin.usuarios.index') }}" class="filters-bar">
        <div class="flex-grow-1" style="min-width: 200px;">
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="search" placeholder="Buscar por nombre, cédula o usuario..." value="{{ request('search') }}">
            </div>
        </div>
        <select class="form-select" name="rol" style="min-width: 150px;">
            <option value="">Todos los roles</option>
            @foreach($roles as $rol)
                <option value="{{ $rol->id }}" {{ request('rol') == $rol->id ? 'selected' : '' }}>{{ ucfirst($rol->nombre) }}</option>
            @endforeach
        </select>
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><span class="fw-medium">{{ $usuario->usuario }}</span></td>
        ...
        <div class="modal-content shadow-lg">
            ...
            <form id="formUsuario" method="POST" action="/admin/usuarios">
                ...
                <div class="modal-body px-4">
                    ...
                    <!-- BUSQUEDA POR CEDULA (solo en creación) -->
                    ...
                    <!-- Info trabajador (solo en edición) -->
                    ...
                    <div class="p-3 rounded mt-3" id="alertaPassword" style="background: #f0f4ff; border: 1px solid #c5d5f0;">
                        <div class="d-flex align-items-start gap-2">
                            ...
                            <small style="color: #1e3c72;">Se generará una contraseña temporal automáticamente. El usuario deberá cambiarla en su primer acceso.</small>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-body px-4">
                <div class="delete-warning">
                    <p class="mb-1 fw-medium" style="color: #c5221f;">Esta acción no se puede deshacer.</p>
