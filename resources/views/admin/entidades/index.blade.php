...
<div class="container-fluid p-0">
    ...
    <div class="tab-content" id="entidadesTabContent">
        ...
        <div class="tab-pane fade show active" id="instituciones" role="tabpanel">
            <div class="tab-header-bar">
                ...
                <button class="btn btn-primary-dark btn-sm" onclick="abrirModalInstitucion()">
                    <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" style="width: 16px; height: 16px; margin-right: 4px;"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>Nueva
                </button>
            </div>
            <div class="table-container" id="tablaInstituciones"><p class="text-center py-4 text-muted">Cargando...</p></div>
        </div>
        ...
        <div class="tab-pane fade" id="departamentos" role="tabpanel">
            <div class="tab-header-bar">
                ...
                <button class="btn btn-primary-dark btn-sm" onclick="abrirModalDepartamento()">
                    <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" style="width: 16px; height: 16px; margin-right: 4px;"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>Nuevo
                </button>
            </div>
            <div class="table-container" id="tablaDepartamentos"><p class="text-center py-4 text-muted">Cargando...</p></div>
        </div>
        ...
        <div class="tab-pane fade" id="responsables" role="tabpanel">
            ...
            <div class="table-container" id="tablaResponsables"><p class="text-center py-4 text-muted">Cargando...</p></div>
        </div>
            ...
            <div class="tab-header-bar">
                <div class="d-flex gap-2">
                    ...
                    <button class="btn btn-outline-primary-dark btn-sm" onclick="expandirTodo()">
                        <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" style="width: 14px; height: 14px; margin-right: 4px;"><polyline points="6 9 12 15 18 9"/></svg>Expandir
                    </button>
                    <button class="btn btn-outline-primary-dark btn-sm" onclick="colapsarTodo()">
                        <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" style="width: 14px; height: 14px; margin-right: 4px;"><polyline points="6 15 12 9 18 15"/></svg>Colapsar
                    </button>
                </div>
            </div>
            <div class="table-container" id="arbolContenedor"><p class="text-center py-4 text-muted">Cargando árbol...</p></div>
        </div>
    </div>
</div>
            ...
            <form id="formInstitucion" novalidate>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-outline-primary-dark" onclick="limpiarFormInstitucion()">
                        <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" style="width:14px;height:14px;margin-right:4px;"><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"/></svg>Limpiar
                    </button>
