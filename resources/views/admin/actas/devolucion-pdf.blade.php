...
<head>
    ...
    <title>Acta de Devolución - {{ $data['numero_acta'] ?? 'N/A' }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="acta-container">
        ...
        <!-- Marca de agua -->
        <div class="watermark">ACTA DE DEVOLUCIÓN</div>
        ...
        <div class="header">
            ...
            <div class="titulo-acta">Acta de Devolución</div>
        </div>
        ...
        <div class="cuerpo">
            <p>
                Mediante el presente instrumento, se certifica que el equipo perteneciente a la entidad
                <span class="destacado">{{ $data['institucion'] ?? 'No especificada' }}</span>,
                ha sido <strong>devuelto</strong> al Departamento de Informática, en las siguientes condiciones:
            </p>
        </div>
        ...
        <div class="datos-equipo">
            ...
            <div class="item">
                ...
                <span class="valor">{{ $data['accesorios'] ?? 'Sin accesorios' }}</span>
            </div>
            <div class="item">
                <span class="label">ESTADO DE DEVOLUCIÓN:</span>
                <span class="valor {{ ($data['estado_devolucion'] ?? 'Buen estado') === 'Buen estado' ? 'estado-bueno' : 'estado-dano' }}">
                    {{ $data['estado_devolucion'] ?? 'Buen estado' }}
                </span>
            </div>
            <div class="item">
                <span class="label">FECHA PRÉSTAMO:</span>
                <span class="valor">{{ $data['fecha_prestamo'] ?? 'N/A' }}</span>
            </div>
            <div class="item">
                <span class="label">FECHA DEVOLUCIÓN:</span>
                <span class="valor">{{ $data['fecha_devolucion'] ?? date('d/m/Y') }}</span>
            </div>
        </div>
        ...
        <div class="firmas">
            <div class="firma-box">
                <div class="linea"></div>
                <div class="nombre">{{ strtoupper($data['responsable_devuelve'] ?? 'No especificado') }}</div>
                <div class="cargo">{{ strtoupper($data['responsable_devuelve_cargo'] ?? '') }}</div>
                <div class="rol">DEVUELVE</div>
            </div>
            <div class="firma-box">
                <div class="linea"></div>
                <div class="nombre">{{ strtoupper($data['responsable_entrega'] ?? 'Departamento de Informática') }}</div>
                <div class="cargo">{{ strtoupper($data['responsable_entrega_cargo'] ?? 'Director de Informática') }}</div>
                <div class="rol entrega">RECIBE</div>
            </div>
        </div>
