...
class EntidadController extends Controller
{
    ...
    {
        // Verificar al menos un permiso de entidades
        if (!auth()->user()->hasPermission('ver-instituciones') &&
            !auth()->user()->hasPermission('ver-departamentos') &&
            !auth()->user()->hasPermission('ver-responsables')) {
            abort(403, 'No tienes permiso para ver entidades');
        }
